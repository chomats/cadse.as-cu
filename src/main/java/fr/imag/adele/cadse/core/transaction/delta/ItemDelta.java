...
public interface ItemDelta extends Item, ItemOrLinkDelta, InternalItemDelta {
	 ...
	 * 
	 * @see
	 * fede.workspace.domain.Item#getOutgoingItemOne(fede.workspace.domain.LinkType
	 * , boolean)
	 */
	 ...
	 * 
	 * @see
	 * fede.workspace.domain.Item#getOutgoingLink(fede.workspace.domain.Item)
	 */
	 ...
	 *            a link type
	 * 
	 * @return the link delta of <code>linkType</code> type coming from this
	 *         item.
	 * 
	 * @throws CadseException
