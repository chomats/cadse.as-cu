...
public interface ITeamChangeObject {
	...
	public abstract void acceptRemoteChange();

	public abstract void refuseRemoteChange();

	public abstract void acceptLocalChange();
