...
public final class Assert {
	...
	public static void hasLink(Item source, Item dest, LinkType lt) {
		Assert.isNotNull(source.getOutgoingLink(lt, dest.getId()));
		Assert.isNotNull(dest.getIncomingLink(lt, source.getId()));
	}
