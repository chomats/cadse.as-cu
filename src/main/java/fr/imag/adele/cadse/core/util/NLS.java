 ...
 * array. Calling the <code>#bind</code> methods with text that does not map
 * to an integer will result in an {@link IllegalArgumentException}.
 * </p>
 * <p>
 ...
 * <code>MessageFormat</code> class should call that class directly and not
 * use these <code>#bind</code> methods.
 * </p>
 * <p>
...
public abstract class NLS {
	...
	private static boolean			DEBUG_MESSAGE_BUNDLES	= false;
	 ...
	 * SEVERITY_WARNING) @param message - message to log @param e - exception to
	 * log
	 */
	static void log(int severity, String message, Exception e) {

		// if (FedeLog.logerror(message, e);
		// if (frameworkLog != null) {
		// frameworkLog.log(new FrameworkLogEntry("org.eclipse.osgi", severity,
		// 1, message, 0, e, null)); //$NON-NLS-1$
		// return;
		// }
		String statusMsg;
		switch (severity) {
